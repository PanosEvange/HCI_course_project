...
<html lang="en">
    ...
    <body>
        ...
        <div class="redirect-sign-up-paragraph">
            <p> Αν είσαι νέος χρήστης πρέπει να εγγραφείς πρωτού συνεχίσεις!</p>
            <div class="my-signup">
                <a href="/secretary/registration_form_secret.php" class="btn" >Εγγραφή</a>
            </div>
        </div>
        ...
        <div class="redirect-login">
                <div>
                    ...
                    <div class="last-actions">
                        ...
                        <a href="#" class="btn btn-primary my-submit" id="redirect-login-submit-button-secretary">Είσοδος</a>
                    </div>
                </div>
        </div>
