<div class="student-app-content">
    <div class="new-dilosi-button student-app-button">
        <a href="./under_construction.php" class="btn"><span class="button-text"><br/>Νέα Δήλωση<br/>Συγγραμμάτων</span></a>
    </div>
    <div class="edit-current-button student-app-button">
        <a href="./under_construction.php" class="btn"><span class="button-text"><br/>Επεξεργασία Τρέχουσας<br/>Δήλωσης</span></a>
    </div>
    ...
    <div class="exchange-button student-app-button">
        <a href="./under_construction.php" class="btn"><span class="button-text"><br/>Ανταλλαγή<br/>Συγγραμμάτων</span></a>
    </div>
    <div class="history-button student-app-button">
        <a href="./under_construction.php" class="btn"><span class="button-text"><br/>Ιστορικό<br/>Δηλώσεων</span></a>
    </div>
