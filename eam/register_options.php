    ...
    <body>
        ...
        <div class="groups-option-registration">
            ...
            <div class="publisher-reg-opt">
                <a href="./registration_form_publisher.php" class="btn"><svg version="1.1" id="Capa_1" width="55px" height="55px" x="0px" y="0px"
            ...
            <div class="library-reg-opt">
                <a href="./under_construction.php" class="btn">
